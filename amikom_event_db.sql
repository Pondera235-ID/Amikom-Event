...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 10 Jan 2020 pada 16.45
...
(16453, 'Jalan jalan pagi', 'jalan jalan aja', 'Tambak boyo', '03 Jan 2020', '22:00', 'Andika'),
(16455, 'Pameran', 'paket\nHahah\nAhhaha', 'Jogja', '09 Jan 2020', '15:00', 'anu'),
(16478, 'Machine Learning', 'Mempelajari bagaimana \nmachine learning bekerja', 'Sleman', '11 Jan 2020', '15:05', 'Bambang');
...
--
ALTER TABLE `event`
  MODIFY `id_event` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16479;
